...
### 模块二：音视频编解码核心原理
- 第6节：视频编码原理（DCT + 量化） ⏳ 待开发
- 第7节：H.264关键帧与参考帧 ⏳ 待开发
- 第8节：音频编码原理（AAC/MP3） ⏳ 待开发
- 第9节：FFmpeg解码器API入门 ⏳ 待开发
- 第10节：FFmpeg内存模型与引用计数 ⏳ 待开发
- 第11节：FFmpeg编码器API入门 ⏳ 待开发

### 模块三：音视频解封装、封装与处理管道
- 第12节：解封装与封装API详解 ⏳ 待开发
- 第13节：解码管道构建 ⏳ 待开发
- 第14节：图像滤镜与转码（libavfilter + libswscale） ⏳ 待开发
- 第15节：音频重采样 ⏳ 待开发
- 第16节：音视频剪辑与拼接 ⏳ 待开发
...
2. **使用教学模板**
   ...
   - 确保包含：引言、理论讲解、环境准备、核心实验、结果预期、课后挑战
